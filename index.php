...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					<li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:info@example.com">nnazmul1526@gmail.com</a></li>
					<li><i class="fa fa-phone" aria-hidden="true"></i>+8801745339896</li>	
					<li class="s-bar">
						<div class="search">
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							...
							<li class="menu__item"><a href="EE/package.php">Places</a></li>
							...
							<!-- Modal content-->
								<div class="modal-content">
									<div class="modal-header">
										...
										<h4>Enjoy  <span>Your Life</span></h4>
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
                            <h3 class="title-w3-agileits title-black-wthree">ABOUT OUR BEST TRAVEL BD</h3> 
	...
	<div class="row">
			...
			<div class="team-member default">
				<div class="person-inner">
					<div class="thumb-avatar">
						<a href="#"><img alt="" src="images/na.jpg"></a>
					...
					<div class="content-person">
						<h3 class="name"><a href="#">Kazi Nazmul Hasan</a></h3>
						<p class="positions">Founder</p>
						<p class="positions">ID : 1901040</p>
						<p class="positions">Department of CSTE</p>
						<p class="positions">Noakhali Science & Technology University</p>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="col-md-3 col-xs-12">
			<div class="team-member default">
				<div class="person-inner">
					<div class="thumb-avatar">
						<a href="#"><img alt="" src="images/sa1.jpg"></a>
						<div class="list-social">
							<a href="#"><i class="fa fa-facebook"></i></a> <a href="#"><i class="fa fa-twitter"></i></a> <a href="#"><i class="fa fa-instagram"></i></a>
						</div>
					</div>
					<div class="content-person">
						<h3 class="name"><a href="#">Sarmin Akter</a></h3>
						<p class="positions">Partner</p>
						<p class="positions">ID : 1901011</p>
						<p class="positions">Department of CSTE</p>
						<p class="positions">Noakhali Science & Technology University</p>
					</div>
				</div>
		...
		<div class="col-md-3 col-xs-12">
			<div class="team-member default">
				<div class="person-inner">
					<div class="thumb-avatar">
						<a href="#"><img alt="" src="images/ra.jpg"></a>
						<div class="list-social">
							<a href="#"><i class="fa fa-facebook"></i></a> <a href="#"><i class="fa fa-twitter"></i></a> <a href="#"><i class="fa fa-instagram"></i></a>
						</div>
					</div>
					 ...
					 <div class="content-person">
						<h3 class="name"><a href="#">Rahad Ibn Alam</a></h3>
						<p class="positions">Partner</p>
						<p class="positions">ID:1901049</p>
						<p class="positions">Department of CSTE</p>
						<p class="positions">Noakhali Science & Technology University</p>
					 </div>
				</div>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+8801745339896</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">nnazmul1526@gmail.com</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Noakhai Science & Technology University</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2023 BEST TRAVEL BD . All Rights Reserved | Design by <a href="index.php">Mission:Impossible</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
